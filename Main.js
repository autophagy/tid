...
var $author$project$Main$init = _Utils_Tuple2(
	{newTimer: $author$project$Main$initTimer, timers: _List_Nil},
...
var $author$project$Main$formatTotalSeconds = function (seconds) {
	return '[' + ($author$project$Main$formatTime(
		$author$project$Main$totalSecondsToHour(seconds)) + (':' + ($author$project$Main$formatTime(
		$author$project$Main$totalSecondsToMinutes(seconds)) + (':' + ($author$project$Main$formatTime(
		$author$project$Main$totalSecondsToSeconds(seconds)) + ']')))));
};
...
var $author$project$Main$updatePageTitle = _Platform_outgoingPort('updatePageTitle', $elm$json$Json$Encode$string);
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'AddTimer':
				var newTimer = model.newTimer;
				var newTimerTemplate = _Utils_update(
					newTimer,
					{id: newTimer.id + 1});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							newTimer: newTimerTemplate,
							timers: A2($elm$core$List$cons, newTimer, model.timers)
						}),
					$elm$core$Platform$Cmd$none);
			case 'DeleteLastTimer':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							timers: A2(
								...
								_List_Nil,
								$elm$core$List$tail(model.timers))
						}),
					$elm$core$Platform$Cmd$none);
			case 'PlayTimers':
				return _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{
							timers: A2(
								...
								function (timer) {
									return !_Utils_eq(timer.id, timerId);
								},
								model.timers)
						}),
					$elm$core$Platform$Cmd$none);
			case 'RefreshTimeLeftTick':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'AlertTick':
				var shouldPlay = $elm$core$List$length(
					A2(
						$elm$core$List$filter,
						function (timer) {
				...
				if (_v3.$ === 'Just') {
					...
					return _Utils_Tuple2(
						...
						$author$project$Main$updatePageTitle(
							$author$project$Main$formatTotalSeconds(t) + ' Tid'));
				} else {
					return _Utils_Tuple2(
						model,
						$author$project$Main$updatePageTitle('Tid'));
				}
		}
	});
var $author$project$Main$AddTimer = {$: 'AddTimer'};
var $author$project$Main$DeleteLastTimer = {$: 'DeleteLastTimer'};
var $author$project$Main$PauseTimers = {$: 'PauseTimers'};
var $author$project$Main$PlayTimers = {$: 'PlayTimers'};
...
var $author$project$Main$viewTimer = function (timer) {
	var viewTimeInput = F3(
		function (timeName, timeValue, updateFunc) {
			return A2(
				$elm$html$Html$input,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$type_('text'),
						$elm$html$Html$Attributes$name(timeName),
						$elm$html$Html$Attributes$maxlength(2),
						$elm$html$Html$Attributes$value(
						$author$project$Main$timerIsPlaying(timer) ? $author$project$Main$formatTime(timeValue) : $elm$core$String$fromInt(timeValue)),
						$elm$html$Html$Attributes$readonly(
						$author$project$Main$timerIsPlaying(timer)),
						$elm$html$Html$Events$onInput(
						A2($author$project$Main$TimerTimeChange, updateFunc, timer.id))
					]),
				_List_Nil);
		});
	var setSeconds = F2(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$elm$core$String$fromInt(timer.id)),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('tid-id')
					]),
				_List_fromArray(
					[
						$elm$html$Html$text(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('tid-time')
					]),
				A2(
					...
					_List_fromArray(
						[
							A3(viewTimeInput, 'hours', timer.timeLeft.hours, setHours),
							A3(viewTimeInput, 'minutes', timer.timeLeft.minutes, setMinutes),
							A3(viewTimeInput, 'seconds', timer.timeLeft.seconds, setSeconds)
						]))),
				A2(
				$elm$html$Html$div,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('tid-title')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$type_('text'),
								$elm$html$Html$Attributes$name('timer-title'),
								$elm$html$Html$Attributes$maxlength(20),
								$elm$html$Html$Attributes$value(timer.title),
								$elm$html$Html$Events$onInput(
								$author$project$Main$TimerTitleChange(timer.id))
							]),
						_List_Nil)
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('tid-control')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$title('Start/Pause the timer'),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$title('Close the timer'),
								$elm$html$Html$Attributes$classList(
								_List_fromArray(
									[
										_Utils_Tuple2('control-item', true),
										_Utils_Tuple2('close-icon', true)
									])),
								$elm$html$Html$Events$onClick(
								$author$project$Main$DeleteTimer(timer.id))
							]),
						_List_Nil)
					]))
			]));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$src('/tid.png'),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$AddTimer)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$DeleteLastTimer)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$PlayTimers)
									]),
								_List_fromArray(
									[
								...
								_List_fromArray(
									[
										$elm$html$Html$Events$onClick($author$project$Main$PauseTimers)
									]),
								_List_fromArray(
									[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$id('tidspace')
					]),
				A2(
					$elm$core$List$map,
					$author$project$Main$viewTimer,
					$elm$core$List$reverse(model.timers)))
			]));
};
